...
// const pageText = document.createElement('h3');
// pageTitle.textContent = "Pong";
// pageText.textContent = "First to 3 wins";
...
function startGame() {
  ...
  canvas.addEventListener('mousemove', (e) => {
    ...
    console.log("paddleDiff: " +paddleDiff);
    playerMoved = true;
    ...
    console.log("paddleBottomX after: " +paddleBottomX);
  });
}
